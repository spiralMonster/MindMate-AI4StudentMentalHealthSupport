...
class ExamPressureHandlerAI:
  def __init__(self):
    ...
    self.embedding_model=GoogleGenerativeAIEmbeddings(model="models/embedding-001",google_api_key='AIzaSyDbNeumk07ozAdTKYVppxdX3BjDBUItyJw')
  ...
  def prompt_generation(self):
    ...
    {query}
    """
    self.problem_checker_prompt=PromptTemplate.from_template(input_variable=['query'],template=temp)
